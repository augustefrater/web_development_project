# Generated by Django 5.1.3 on 2025-04-11 09:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='warnings_created', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assigned_role', models.CharField(choices=[('Technician', 'Technician'), ('Repair', 'Repair'), ('Manager', 'Manager'), ('ViewOnly', 'ViewOnly')], help_text='Role assigned to the user for this specific machine.', max_length=10)),
